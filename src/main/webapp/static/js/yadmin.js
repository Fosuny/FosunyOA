layui.define(["element", "layer"], function (exports) {
    ...
    var yadmin = {
        ...
        //GitHub
        github: function () {
            window.open('https://github.com/Fosuny');
        },
        //前台
        website: function () {
        ...
        notification: function () {
            ...
            layer.open({
                ...
                offset: [X - 595, Y + 180], 
                shadeClose: true,
                content: '/FosunyOA/oanav/messaging'
            });
        },
        //个人中心
        userInfo: function () {
            layer.open({
                ...
                area: ['480px', '537px'],
                shadeClose: true,
                content: '/FosunyOA/oanav/userInfo'
            });
        },
        //修改密码
        editPwd: function () {
            layer.open({
                ...
                area: ['470px', '290px'],
                shadeClose: true,
                content: '/FosunyOA/oanav/editPwd'
            });
        },
